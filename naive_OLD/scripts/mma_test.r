...
input_file <- "/Users/tedmccarthy/Documents/Research\ Projects/CHW\ Outlier\ Detection/modified_data/ASHAs_only-three_removed.csv"
...
output_file <- paste(output_dir, "scores_output-all_collection-three_removed.csv", sep="")
