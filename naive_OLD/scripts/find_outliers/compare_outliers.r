...
# Directories
#####
output_dir <- "/Users/tedmccarthy/Dropbox/Outlier\ Detection/output_data/find_outliers/"
...
for (c in unique_chws){
	...
	one_row <- subset(one_row, select=c(c, over_count, over_ratio, num_over, percent_over))
