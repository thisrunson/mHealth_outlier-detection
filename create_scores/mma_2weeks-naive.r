...
output_dir <- paste(top_dir, "output_data/naive/", sep="")
...
date_breaks <- seq.Date(from=as.Date('2012-07-31'), to=as.Date('2013-08-01'), by="2 weeks") 
...
for(date in date_breaks){
	...
	output_file <- paste(output_dir, "scores_questions-2weeks/scores_output-questions_by_2week-", date_label, ".csv", sep="")
