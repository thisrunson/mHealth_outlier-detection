...
input_file <- "/Users/tedmccarthy/Dropbox/Outlier Detection/modified_data/ASHAs_only.csv"
...
date_breaks <- seq.Date(from=as.Date('2012-07-31'), to=as.Date('2013-06-01'), by="month") 
...
for(date in date_breaks){
	...
	output_file <- paste(output_dir, "scores_output-questions_by_month-", date_label, ".csv", sep="")
